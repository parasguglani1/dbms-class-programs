...
Case salary
 when salary > 40000 then
    update employee set Eaddress = 'delhi';
else
    update employee set Eaddress = 'Meerut';
end case;
...
CASE Eaddress
 when 'Meerut' then
    update employee set Eaddress = 'delhi' when Eaddress ='Meerut'
else
    update employee set Eaddress = 'Meerut'  when Eaddress ='Meerut'
    END case;
